...
if($math == '7'):
mail($to,'Website Applicant: Testing ' . $firstName .'', $body, $headers);
endif;
$message_sent = true;
...
<div class="row">
<div class="col-12">
<h1 style="padding-bottom:25px;">Application: Testing Notificationas</h1>
...
<form id="contact-form" class="row" action="contact-form-test.php" method="POST">
