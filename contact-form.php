   ...
   function onSubmit(token) {
    ...
    if(isset($_POST['email']) && $_POST['email'] != '' ){
        if(filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
            ...
            $to = "info@concare.com";
            // $to = "efrain@insideoutfocus.com,info@concare.com,garrett@insideoutfocus.com";
...
$body .= '</table>';
            ...
            if($math == '7'):
            mail($to,'Website Applicant: Warehouse Assistant from ' . $firstName .'', $body, $headers);
            endif;
            $message_sent = true;
...
<section style="padding:100px 0;">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 style="padding-bottom:25px;">Application: Warehouse Assistant - Part-Time</h1>
            ...
            <form id="contact-form" class="row" action="contact-form.php" method="POST">
    <!-- <div>
...
<br>
    ...
    <div class="">
    <!-- <input type="submit" value="Send" style="background:#0074C8;color:white;width:103.5%;" class="g-recaptcha" 
